...
bc. public Vertex addVertex(Object id);
...
bc. public void startTransaction();
...
bc. public <T extends Element> Index<T> createIndex(String indexName, Class<T> indexClass, Index.Type type);
...
bc. public Object getProperty(String key);
...
bc. public Iterable<Edge> getOutEdges();
public Iterable<Edge> getInEdges();

h3. Edge (extends Element)

bc. public Vertex getOutVertex();
public Vertex getInVertex();
public String getLabel();

h2. Index [T extends Element]

bc. public String getIndexName();
...
bc. public void addAutoIndexKey(String key);

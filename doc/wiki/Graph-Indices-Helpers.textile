...
indexKeys.add("name");
AutomaticIndex index = graph.createAutomaticIndex("test-idx", Vertex.class, indexKeys);
index.get("name","marko"); // returns an empty iterator
AutomaticIndexHelper.reIndexElements(index, graph.getVertices()); // reindex all the vertices in the graph

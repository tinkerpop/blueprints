...
h3(#create). Create a Simple Graph
...
h3(#elements). Iterate through the Elements of a Graph
...
h3(#edge). Iterate through the Edges of a Vertex
...
h3(#index). Use Indices to Get a Vertex by its Property

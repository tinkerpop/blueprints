Blueprints is a generic graph Java API that binds to various graph backeds (i.e. frameworks and "databases":http://en.wikipedia.org/wiki/Graph_database). Below is a list of reasons for using Blueprints.

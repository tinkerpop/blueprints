...
public class RedisVertexIterator extends RedisElementIterator {
    public RedisVertexIterator(final RedisElementType.TYPE type, final RedisVertexIterable iterable) {
        super(RedisElementType.TYPE.REDIS_ELEMENT_VERTEX, iterable);
    }
}

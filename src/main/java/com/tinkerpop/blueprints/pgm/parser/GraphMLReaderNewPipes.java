 ...
 */
public class GraphMLReaderNewPipes {

	public static void inputGraph(final Graph graph,
			final InputStream graphMLInputStream, final int bufferSize)
			throws XMLStreamException, IOException {
		XMLInputFactory inputFactory = XMLInputFactory.newInstance();

		InputStream labeledGraphMLInputStream = GraphMLEventLabeler
				.getInputStream(graphMLInputStream, null, null);

		// This is the only new line
		XMLStreamReader reader = inputFactory
				.createXMLStreamReader(labeledGraphMLInputStream);
	...
	public static void inputGraph(final Graph graph,
			...
			IOException {
		GraphMLReaderNewPipes.inputGraph(graph, graphMLInputStream, 1000);
	}

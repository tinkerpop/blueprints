 ...
 */
public abstract class OrientBaseGraph implements Graph, MetaGraph<ODatabaseDocumentTx> {
    ...
    private void removeContext() {
        ...
        if (context != null) {
            for (OrientIndex<? extends Element> idx : context.manualIndices.values())
                idx.close();
    ...
    public <T extends Element> void dropIndex(final String key,

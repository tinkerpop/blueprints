...
public class OrientGraphSpecificTestSuite extends TestSuite {
    ...
    public void testComplexMapProperty() throws Exception {
        // complex map properties have problems when unmarshalled from disk to an OTrackedMap
        ...
        // have to shutdown the graph so that the map will read back out as an OTrackedMap.  Maps that exist in memory
        ...
        // check the delivery address.  not sure if there should be other assertions here, but the basic issues
        // is that the keys/values in the OTrackedMap appear like this: mobileTelephone=null:null

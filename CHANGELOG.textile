...
h3. Version 1.2 (NOT OFFICIALLY RELEASED YET)
...
* Added @NamedGraph@ utility to allow for graph partitions
* Renamed packages where there is no @util.io@ and @util.wrappers@ for I/O and wrapper-based utilities

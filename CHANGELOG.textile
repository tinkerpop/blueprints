...
** Added @IndexableGraph@ interface
** Added support for manual indexing through @Index@
** Added support for auto indexing through @AutomaticIndex@
** Added numerous test cases to the test suite
* Removed support for TinkerDoc, MongoDB, and CouchDB
* Updated of @GraphMLReader@
** More efficient implementation
** Can specify ids and labels through @_id@ and @_label@ data properties
* Added @GraphMigrator@ to stream the data in on graph to another

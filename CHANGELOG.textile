...
* Deprecated @Query.has(key,value,compare)@ and added @Query.has(key,compare,value)@
* Bumped Dex to 4.8.0
...
* Bumped Neo4j to 1.9
* Added support for @has(key)@ and @hasNot(key)@ in @Query@ API
* Added support for @has(key,value)@ and @hasNot(key,value)@ in @Query@ API
* Added support for @has(key,CompareRelation,values...)@ in @Query@ API
* Added @CompareRelation@ interface to support future compare-type operations
* Added support for @limit(skip,take)@ in the @Query@ API

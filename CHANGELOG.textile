...
* Bumped to support OrientDB 1.0rc3
* @IndexableGraph.getIndex()@ new return @null@ for non-existent indices instead of @RuntimeException@
...
* Changed the property graph schema of GraphSail to more closely resemble SailGraph's

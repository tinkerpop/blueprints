...
* Added @AggregatorPipe@ to aggregate incoming iterator into a collection
* Added @FilterPipe@ interface to support overrighting comparators in filter-based pipes
* Added @CountPipe@ that maps an iterator to the number of elements in the iterator
* Added @PropertyFilterPipe@ that filters graph elements based on their properties

...
import com.tinkerpop.blueprints.pgm.util.io.graphml.GraphMigrator;
...
public class GraphSONReaderTestSuite extends TestSuite {
    ...
    public void testReadingTinkerGraph() throws Exception {
        ...
        if (!graphTest.ignoresSuppliedIds) {
            this.stopWatch();
            new GraphSONReader(graph).inputGraph(GraphSONReader.class.getResourceAsStream("graph-example-1.xml"));
    ...
    public void donttestGratefulGraph() throws Exception {
        ...
        if (graphTest.supportsVertexIndex) {
            for (int i = 200; i < 1002; i = i + 200) {
                ...
                this.stopWatch();
                new GraphSONReader(graph).inputGraph(GraphSONReader.class.getResourceAsStream("graph-example-2.xml"), i);
    ...
    public void testReadingTinkerGraphExample3() throws Exception {
        ...
        if (!graphTest.ignoresSuppliedIds && graphTest.supportsEdgeIteration && graphTest.supportsVertexIteration) {
            ...
            this.stopWatch();
            new GraphSONReader(graph).inputGraph(GraphSONReader.class.getResourceAsStream("graph-example-3.xml"), 1000);
    ...
    public void testReadingTinkerGraphExample3MappingLabels() throws Exception {
        ...
        if (graphTest.supportsEdgeIteration && graphTest.supportsVertexIteration) {
            this.stopWatch();
            GraphSONReader r = new GraphSONReader(graph);
